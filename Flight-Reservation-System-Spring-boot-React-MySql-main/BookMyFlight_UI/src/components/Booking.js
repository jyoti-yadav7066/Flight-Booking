    ...
    goOnPassangers = () => {
        ...
        this.service.addBooking(this.state.numberOfSeatsToBook, this.state.flightNumber, this.state.source, this.state.destination, this.state.date
            ...
            if (response.data.length > 3) {
                alert(response.data); // Show error from server
            }
            else {
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                {this.flag &&
                                                                    <select class="form-control" name="nop" onChange={this.change} value={this.state.numberOfSeatsToBook} required>
                                                                        <option value="">Select No. of Passengers</option>
                                                                        {this.state.passengers.map(psng => (
                                                                            psng > 0 && <option value={psng}>{psng}</option>
                                                                        ))}
                                                                    </select>
                                                                }

                                                ...
                                                <div className="container">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-6">
                                                            <span><h6>CREDIT/DEBIT CARD / UPI</h6></span>
                                                        </div>
                                                    ...
                                                    <form>
                                                        ...
                                                        <div className="card-footer">
                                                            <div className="col-md-12 text-center">
                                                                <button type="button" onClick={this.handlePayment} className="subscribe btn btn-primary btn-block shadow-sm"> Pay Now </button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
